...
expect(calculator(['sub', 10, 1]), 9);
expect(calculator(['add', 'apple', 4]), undefined);
expect(calculator(['', 2, 4]), undefined);
expect(calculator(['add', 2, '']), undefined);
expect(calculator(['mult', 2, 4, 9]), 8);
expect(calculator(['sub', 12, 5], 'mult'), 7);
